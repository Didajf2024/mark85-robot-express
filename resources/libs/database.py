...
client = MongoClient('mongodb+srv://qa:xperience@cluster0.gywhznl.mongodb.net/?appName=Cluster0')
...
def clean_user(email):
    ...
    if (u): 
        tasks.delete_many('users': u['_id'])
        users.delette_many({'email': user_email})
